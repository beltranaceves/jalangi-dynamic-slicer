...
function analyze(args) {
  var instUtil = require("../../node_modules/jalangi2/src/js/instrument/instUtil.js");
  var astHandler = null;
  ...
  require("../../node_modules/jalangi2/src/js/headers").headerSources.forEach(function (header) {
    require("../../node_modules/jalangi2/" + header);
  });
